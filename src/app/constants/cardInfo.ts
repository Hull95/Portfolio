...
// Screenshots of the Beogradske Elektrane / Srbija Šume Web GIS platform.
const bgelImages = [
...
export const CardsInfo: ProjectType[] = [
    {
        title: 'FK Borac Ticketing System (Online Ticket Sales)',
        description: 'Built an online ticketing platform for FK Borac, covering match listings, seat and stand selection, and a full checkout flow with Monri payment gateway integration for secure card payments.',
        tags: ['react', 'typescript', 'monri', 'react-hook-form', 'axios'],
        link: 'https://karte.fkborac.net'
    },
    {
