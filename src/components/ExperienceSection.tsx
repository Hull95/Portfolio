...
export default function ExperienceSection() {
  return (
    <section id="experience" className="w-full py-10 px-4 md:px-0 flex flex-col items-center bg-white">
      <h2 className="text-2xl pt-4 mb-8 text-main-green">Experience</h2>
        ...
        {experiencesInfo.map((exp, idx) => (
          ...
          >
            <div className="flex-1">
              ...
              <div className="text-gray-700 font-semibold mb-1">{exp.company} <span className="text-gray-400 font-normal">| {exp.location}</span></div>
