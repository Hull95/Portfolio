    ...
    return (
        <section id="experience"
            ...
            <div className="relative w-full max-w-7xl">
                <div
                    className="absolute left-6 md:left-1/2 transform md:-translate-x-1/2 h-full w-0.5 bg-main-blue"></div>
                ...
                {experiencesInfo.map((exp, idx) => (
                    ...
                    >
                        <div
                            className="absolute left-6 md:left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3 h-3 bcg-main-green rounded-full z-10"></div>
                        ...
                        <div className={`w-full md:w-6/12 pl-16 md:pl-0 ${idx % 2 === 0 ? 'md:pr-8' : 'md:pl-8'}`}>
                            <div
                                ...
                                <div
                                    className="inline-block bcg-main-blue text-white px-3 py-1 rounded-full text-sm font-semibold mb-3">
                                    {exp.period}
                                </div>
